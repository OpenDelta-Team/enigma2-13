...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "delta-neon-fhd/skin.xml" or "delta-purple-fhd/skin/skin.xml"  # SD hardware is no longer supported by the default skin.

...
DEFAULT_SKIN = BoxInfo.getItem("HasFullHDSkinSupport") and "delta-purple-fhd/skin.xml" or "AREADELTASAT-FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
